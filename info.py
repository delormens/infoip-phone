...
def receiving_data_ip():
    while True:
        try:
            ...
            print(f'{CYAN}{BOLD}[#] {LI_G}Поддержка: {DARK}https://www.donationalerts.com/r/delormen/{RESET}')
...
def num_mnp_request():
    while True:
        try:
            ...
            print(f'{PINK}{BOLD}[#] {LI_G}Поддержка: {DARK}https://www.donationalerts.com/r/delormen{RESET}')
            print(f'{PINK}{BOLD}[#] {LI_G}Пример: {DARK}+7 999 999 99-99{RESET}')
            ...
            if number.isdigit():
                ...
                print(f'{PINK}{BOLD}[!] {RED}"{RESET}{number}{RED}" - эти цифры не является номером\n{RESET}')
                sleep(1)
                clear()
                continue
...
def save():
    with open('data.txt', 'a', encoding='utf-8') as fileD:
...
while True:
    try:
        ...
        banner()
        print(f'{YELLOW}{BOLD}[#] {LI_G}Поддержка: {DARK}https://www.donationalerts.com/r/delormen{RESET}')
        ...
        try:
            ...
            if interNet == 0:
                ...
                print(f'\n{YELLOW}{BOLD}[+] {LI_G}Данные о номере: +{str(number)} добавлены в файл {RESET}data.txt')
